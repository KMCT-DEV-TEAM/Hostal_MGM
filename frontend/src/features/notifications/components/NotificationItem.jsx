...
const NotificationItem = ({ type, title, sender, description, timeAgo, isRead = false }) => {
    return (
        <div className="flex gap-4 py-4 px-2 hover:bg-gray-50/80 transition-colors rounded-xl cursor-pointer">
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-center relative">
                <div className="flex justify-between items-center mb-0.5">
                    <h4 className="text-[14px] font-bold text-gray-900 leading-none">{title}</h4>
                    <span className="text-[10px] text-gray-400 whitespace-nowrap ml-2 leading-none">{timeAgo}</span>
                </div>
                <div className="text-[11px] text-gray-400 mb-2 leading-none">
