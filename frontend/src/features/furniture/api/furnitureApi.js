...
const getAllFurnitureAssets = (params) => apiClient.get(`${API_BASE_URL}/assets/all-hostel`, { params });
...
const getAvailableFurnitureAssetsList = (typeId, params) => apiClient.get(`${API_BASE_URL}/types/${typeId}/available-assets`, { params });
...
const getDashboardStats = () => apiClient.get(`${API_BASE_URL}/dashboard/summary`);
const getAssetsDashboardSummary = (typeId) => apiClient.get(`${API_BASE_URL}/assets/dashboard/summary`, { params: { typeId } });
