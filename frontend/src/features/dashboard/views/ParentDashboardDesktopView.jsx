...
export default function ParentDashboardDesktopView({
    user,
    period,
    setPeriod,
    radialPeriod,
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm flex flex-col">
                        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                            ...
                            <button 
                                onClick={() => onNavigate('/dashboard/visitors/history')}
                                className="text-xs text-[#777777] font-medium hover:underline cursor-pointer"
                            >
                                View all
                            </button>
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            {visitors.length > 0 ? visitors.map((visitor) => (
                                <div key={visitor.id} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white border border-[#EEF2F7] rounded-[14px] p-4">
