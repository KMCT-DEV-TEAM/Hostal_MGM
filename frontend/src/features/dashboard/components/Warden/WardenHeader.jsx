                ...
                {selectedIds.length > 0 && (
                    <div className="flex items-center gap-2 mr-2">
                        <button
                            ...
                            className="px-3 py-2 bg-green-50 text-success border border-green-200 hover:bg-green-100 rounded-lg text-sm font-medium transition-colors cursor-pointer"
                        >
