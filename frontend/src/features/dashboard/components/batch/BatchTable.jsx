                    ...
                    <tr className="text-[#222222] text-center text-sm font-semibold border-b border-gray-50">
                        <th className="p-4 w-12 text-center">
                            <button onClick={handleSelectAll} className="focus:outline-none text-gray-300 hover:text-gray-500 cursor-pointer">
                                {batches.length > 0 && batches.every(h => selectedIds.includes(h._id)) ? (
                        ...
                        <th className="p-4 text-start">Batch Code</th>
                        <th className="p-4 text-start">Department</th>
                        <th className="p-4 text-center">Number of Students</th>
