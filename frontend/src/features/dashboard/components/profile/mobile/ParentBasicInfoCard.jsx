        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mt-4">
            ...
            <div className="p-4 flex flex-col gap-5">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <p className="text-[10px] font-semibold text-gray-400 uppercase tracking-wider mb-0.5">Active Student</p>
                        <p className="text-sm font-medium text-text-primary">{activeStudent?.name || 'No value'}</p>
                    </div>
                </div>
...
export default ParentBasicInfoCard;
