...
import { Pencil, FileText, Layers, Square, CheckSquare } from 'lucide-react';
...
const CourseMobileList = ({
    ...
    const isAllSelected = courses.length > 0 && courses.every(o => selectedIds.includes(o._id));
                    ...
                    <div key={o._id} className={`bg-white p-4 rounded-xl shadow-sm flex flex-col relative border ${isSelected ? 'border-[#0A437A] bg-blue-50/20' : 'border-transparent'}`}>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0 pr-6">
                                ...
                                <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-[10px] sm:text-xs text-gray-500 mb-3">
                                    ...
                                    <div className="flex items-center gap-1">
                                        ...
                                        <span>{o.batchesCount || 0} Batches</span>
                                    </div>
                                </div>
                            </div>
                        </div>
